...
public class awsTest {
	...
	public static void main(String[] args) throws Exception {
		...
		while(true)
		{
			...
			System.out.println("  9. condor status               10. none                   ");
	...
	public static void condor_status() {
		System.out.println("Checking HTCondor status...");

		// 이 부분은 Condor CLI를 호출하거나 REST API를 사용하는 방식으로 대체해야 합니다.
		try {
			Process process = Runtime.getRuntime().exec("condor_status");
			...
			scanner.close();
			process.waitFor();
			System.out.println("HTCondor status fetched successfully.");
		} catch (Exception e) {
			System.out.println("Error while fetching HTCondor status: " + e.getMessage());
		}
	}
}
